...
baselinesurvey = Survey.find_or_create_by_name({:name => 'Phase 5',:title=>'RISE@Work Follow-up Questionnaire',:description => 'Before you begin the RISE@Work program, we are interested in finding out about your general health and wellbeing.'}, :without_protection => true)
baselinesurvey.save
...
section1 = SurveySection.find_or_create_by_name({:name => 'FSection1',:title=>'Section 1: Getting to Know You',:description => 'Please answer the following demographic questiosn so that we may know you better.'}, :without_protection => true)
section1.save

baselinesurvey.survey_sections <<  section1;

section2 = SurveySection.find_or_create_by_name({:name => 'FSection2',:title=>'Section 2: Your Physical Activity',:description => 'Please answer the following demographic questiosn so that we may know you better.'}, :without_protection => true)
section2.save

baselinesurvey.survey_sections <<  section2;

section3 = SurveySection.find_or_create_by_name({:name => 'FSection3',:title=>'Section 3: Your Sitting',:description => 'Please answer the following demographic questiosn so that we may know you better.'}, :without_protection => true)
section3.save

baselinesurvey.survey_sections <<  section3;

section4 = SurveySection.find_or_create_by_name({:name => 'FSection4',:title=>'Section 4: Your Work',:description => 'Please answer the following demographic questiosn so that we may know you better.'}, :without_protection => true)
section4.save

baselinesurvey.survey_sections <<  section4;

section5 = SurveySection.find_or_create_by_name({:name => 'FSection5',:title=>'Section 5: General  Wellbeing',:description => 'Please answer the following demographic questiosn so that we may know you better.'}, :without_protection => true)
section5.save

baselinesurvey.survey_sections <<  section5;

section6 = SurveySection.find_or_create_by_name({:name => 'FSection6',:title=>'Section 6: Impressions of RISE@Work',:description => 'Please answer the following demographic questiosn so that we may know you better.'}, :without_protection => true)
section6.save
...
###### Intro Questions ######
question0 = SurveyQuestion.find_or_create_by_name({:name => 'FInformation0',:description=>'
<p>As a final request, we would like to ask some broad questions about you, your physical activity participation, sitting time, work productivity and general questions about your health and wellbeing. Many of these questions are the same as the ones that you were asked before starting the program. We would also like to hear about your impressions of the RISE@Work website and program, so be sure to complete all of the questions!</p>
<p>This questionnaire will take about 20 minutes to complete. As a reminder, all of the information that you provide will be kept in the strictest confidence.</p>
...
question40 = SurveyQuestion.find_or_create_by_name({:name => 'FInformation40',:description=>'<p>For the following section, we are interested in learning more about your work environment. In particular, this next set of questions asks about the type of job you currently are employed at, the amount of time you usually spend at work, how you typically travel to and from work, as well as any physical activity you may participate in at work. </p>',:question_type => 'INFORMATION'}, :without_protection => true)
...
question401 = SurveyQuestion.find_or_create_by_name({:name => 'FInformation401',:description=>'<p>Health problems can make it difficult for employees to perform certain aspects of their jobs.  We are interested in learning about how your health may have affected you at work over the <u>past 2 weeks</u>. The next eight questions will ask you to think about your physical health or emotional problems.  These refer to any <u>ongoing or permanent medical conditions</u> you may have and the effects of any <u>treatments</u> you are taking for these conditions.  Emotional problems may include feeling depressed or anxious.
...
question50 = SurveyQuestion.find_or_create_by_name({:name => 'FInformation50',:description=>'<p>For this section of the questionnaire, we are interested in learning about your overall satisfaction with different aspects of your life. In particular, this next set of questions refers to satisfaction with your physical, social, and emotional functioning.</p>',:question_type => 'INFORMATION'}, :without_protection => true)
...
question60 = SurveyQuestion.find_or_create_by_name({:name => 'FInformation60',:description=>'<p>The final section of this questionnaire asks you about your feelings towards various aspects of the RISE@Work website. Where possible, adjustments will be made to the website to reflect this feedback and improve participant experiences. For each of the following questions, please let us know how much you agree or disagree with the statements.</p>',:question_type => 'INFORMATION'}, :without_protection => true)
...
question70 = SurveyQuestion.find_or_create_by_name({:name => 'FInformation70',:description=>'
...
@description5 = '<p>For the following questions we would like you to consider how much time (minutes) you spent sitting over the last 7 days. For example, 2 hours of sitting = 120 minutes, 4 hours = 240 minutes, and 8 hours = 480 minutes.</p>'
...
question1 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion1',:question=>'How much do you weigh (wearing light clothing and no shoes)?',:description=>@description,:question_type => 'WEIGHT'}, :without_protection => true)
question1.save
...
question21 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion21',:question=>'During the last 7 days, on how many days did you do vigorous physical activities like heavy lifting, digging, aerobics, or fast bicycling?',:description=>@description2,:question_type => 'DAYSPERWEEKV'}, :without_protection => true)
question21.save
...
question22 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion22',:question=>'How much time did you usually spend doing vigorous physical activities on <u>one</u> of those days?',:description=>@description2,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question22.save
...
question25 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion25',:question=>'How much time did you usually spend doing moderate physical activities on <u>one</u> of those days?',:description=>@description3,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question25.save
...
question27 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion27',:question=>'During the <b>last 7 days</b>, on how many days did you <b>walk</b> for <u>at least 10 minutes at a time?</u>',:description=>@description4,:question_type => 'DAYSPERWEEKW'}, :without_protection => true)
question27.save
...
question25.save
question28 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion28',:question=>'How much time did you usually spend walking on <u>one</u> of those days?',:description=>@description4,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question28.save
...
question31 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion31',:question=>'During the last 7 days, how much time (minutes) did you spend sitting each day?<br>On a work day:',:description=>@description5,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question31.save
...
question32 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion32',:question=>'During the last 7 days, how much time (minutes) did you spend sitting each day?<br>On a non-workday:',:description=>@description5,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question32.save
...
question33 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion33',:question=>'On a work day:<br>a)  While travelling to and from places',:description=>@description6,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question33.save
...
question34 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion34',:question=>'On a work day:<br>b)  At your work desk',:description=>@description6,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question34.save
...
question33.save
question35 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion35',:question=>'On a work day:<br>c)  While watching television',:description=>@description6,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question35.save
...
question36 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion36',:question=>'On a non-work day:<br>a)  While travelling to and from places',:description=>@description6,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question36.save
...
question37 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion37',:question=>'On a non-work day:<br>b)  While watching television',:description=>@description6,:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question37.save
...
question45 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion45',:question=>'On average, how active do you think you are during your working day? Choose <u>one</u> of the following answers:',:description=>"",:question_type => 'ACTIVITYLEVEL'}, :without_protection => true)
question45.save
...
question46 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion46',:question=>'Does your journey to and from work involve any active transport (i.e., walking, running, cycling, or a combination of these activities for 10 minutes or more)?',:description=>"",:question_type => 'YESNOSKIP'}, :without_protection => true)
question46.save
...
question47 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion47',:question=>'How many minutes do you spend each day being active during your journey <u>to and from</u> work?',:description=>"",:question_type => 'MINUTESPERDAY'}, :without_protection => true)
question47.save
...
question48 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion48',:question=>'In the <u>past 2 weeks</u>, how much of the time did your physical health or emotional problems make it difficult for you to get going easily at the beginning of the workday?',:description=>"",:question_type => 'JOBDIFFICULT'}, :without_protection => true)
question48.save
...
question49 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion49',:question=>'In the <u>past 2 weeks</u>, how much of the time did your physical health or emotional problems make it difficult for you to start your job as soon as you arrived at work?',:description=>"",:question_type => 'JOBDIFFICULT'}, :without_protection => true)
question49.save
...
question410 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion410',:question=>'In the <u>past 2 weeks</u>, how much of the time were you able to sit, stand, or stay in one position for longer than 15 minutes while working, without difficulty caused by physical health or emotional problems?',:description=>@description7,:question_type => 'JOBCOMPLETION'}, :without_protection => true)
question410.save
...
question49.save
question411 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion411',:question=>'In the <u>past 2 weeks</u>, how much of the time were you able to repeat the same motions over and over again while working, without difficulty caused by physical health or emotional problems?',:question_type => 'JOBCOMPLETION'}, :without_protection => true)
question411.save
...
question412 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion412',:question=>'In the <u>past 2 weeks</u>, how much of the time did your physical health or emotional problems make it difficult for you to concentrate on your work?',:description=>@description8,:question_type => 'JOBDIFFICULT'}, :without_protection => true)
question412.save
...
question413 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion413',:question=>'In the <u>past 2 weeks</u>, how much of the time did your physical health or emotional problems make it difficult for you to speak with people in-person, in meetings, or on the phone?',:description=>@description9,:question_type => 'JOBDIFFICULT'}, :without_protection => true)
question413.save
...
question414 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion414',:question=>'In the <u>past 2 weeks</u>, how much of the time did your physical health or emotional problems make it difficult for you to handle the workload?',:description=>@description10,:question_type => 'JOBDIFFICULT'}, :without_protection => true)
question414.save
...
question415 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion415',:question=>'In the <u>past 2 weeks</u>, how much of the time did your physical health or emotional problems make it difficult for you to finish work on time?',:description=>@description10,:question_type => 'JOBDIFFICULT'}, :without_protection => true)
question415.save
...
question51 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion51',:question=>'In general, would you say your health is:',:description=>"",:question_type => 'HEALTH'}, :without_protection => true)
question51.save
...
question52 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion52',:question=>'Moderate activities such as moving a table, pushing a vacuum cleaner, bowling or playing golf. If so, how much?',:description=>@description11,:question_type => 'ACTIVITYLIMIT'}, :without_protection => true)
question52.save
...
question53 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion53',:question=>'Climbing several flights of stairs. If so, how much?',:description=>@description13,:question_type => 'ACTIVITYLIMIT'}, :without_protection => true)
question53.save
...
question54 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion54',:question=>'During the past <u>12 weeks</u>, have you accomplished less than you would like as a result of your <u>physical health</u>?',:description=>"",:question_type => 'YESNO'}, :without_protection => true)
question54.save
...
question55 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion55',:question=>'During the past <u>12 weeks</u>, were you limited in the kind of work or other regular activities you do as a result of your <u>physical health</u>?',:description=>"",:question_type => 'YESNO'}, :without_protection => true)
question55.save
...
question56 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion56',:question=>'During the past <u>12 weeks</u>, have you accomplished less than you would like to as a result of any <u>emotional problems</u>, such as feeling depressed or anxious?',:description=>"",:question_type => 'YESNO'}, :without_protection => true)
question56.save
...
question57 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion57',:question=>'During the past <u>12 weeks</u>, did you not do work or other regular activities as carefully as usual as a result of any <u>emotional problems</u> such as feeling depressed or anxious?',:description=>"",:question_type => 'YESNO'}, :without_protection => true)
question57.save
...
question58 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion58',:question=>'How many <u>hours</u> (0-8) in a typical 8-hour work day does back pain interfere with accomplishing tasks at work?',:description=>"",:question_type => 'HOURSPERDAY'}, :without_protection => true)
question58.save
...
question59 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion59',:question=>'How many <u>hours</u> (0-8) in a typical 8-hour work day does depression or anxiety interfere with accomplishing tasks at work?',:description=>"",:question_type => 'HOURSPERDAY'}, :without_protection => true)
question59.save
...
question510 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion510',:question=>'During the past <u>12 weeks</u>, how much did <u>physical pain</u> interfere with your normal work, including both work outside the home or housework?',:description=>"",:question_type => 'CONCENTRATION'}, :without_protection => true)
question510.save
...
question59.save
question511 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion511',:question=>'During the past <u>12 weeks</u>, how much difficulty did you have concentrating at work and accomplishing tasks because of <u>physical or emotional</u> problems?',:description=>"",:question_type => 'CONCENTRATION'}, :without_protection => true)
question511.save
...
question512 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion512',:question=>'How much time during the past <u>12 weeks</u> have you felt down?',:description=>@description12,:question_type => 'FEELING'}, :without_protection => true)
question512.save
...
question513 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion513',:question=>'During the past <u>12 weeks</u>, how much of the time has your <u>physical health or emotional problems</u> interfered with your social activities like visiting with friends, relatives etc.?',:description=>"",:question_type => 'FEELING'}, :without_protection => true)
question513.save
...
question514 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion514',:question=>'How much time during the past <u>12 weeks</u> have you felt calm and peaceful?',:description=>"",:question_type => 'FEELING'}, :without_protection => true)
question514.save
...
question513.save
question515 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion515',:question=>'How much of the time during the past <u>12 weeks</u> did you have a lot of energy?',:description=>"",:question_type => 'FEELING'}, :without_protection => true)
question515.save
...
question61 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion61',:question=>'Accessibility - the site loaded quickly',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question61.save
...
question62 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion62',:question=>'Accessibility - the pictures and labels in each section of the dashboard were easy to understand',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question62.save
...
question63 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion63',:question=>'Navigation - it was easy for me to find what I was looking for',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question63.save
...
question64 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion64',:question=>'Navigation - the <u>Help</u> tutorial pages were useful to consult whenever I had any questions',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question64.save
...
question65 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion65',:question=>'Design - the site was aesthetically appealing and I liked the colour choices',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question65.save
...
question66 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion66',:question=>'Design - the layout worked well on my computer and/or mobile device',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question66.save
...
question67 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion67',:question=>'Privacy and Security - I felt that the information that I entered on the website was secure',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question67.save
...
question68 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion68',:question=>'Content - the text was informative and helpful',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question68.save
...
question69 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion69',:question=>'Content - the graphs updated each time I logged new steps',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question69.save
...
question610 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion610',:question=>'Motivational Tools - the Daily Steps, Steps over Phase and Overall Progress graphs were great motivational tools',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question610.save
...
question611 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion611',:question=>'Motivational Tools - the Achievement Badges were great motivational tools',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question611.save
...
question612 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion612',:question=>'Motivational Tools - the green Performance Bar on the dashboard that summarized my step stats and days left in each phase was a great motivational tool',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question612.save
...
question613 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion613',:question=>'Take a Stand - the Take a Stand alert application was relevant and useful for me',:description=>"",:question_type => 'AGREENA'}, :without_protection => true)
question613.save
...
question614 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion614',:question=>'Support Strategies - the variety of support strategies (e.g., park it, active emails, stand-walk-talk) was relevant and useful for me',:description=>"",:question_type => 'AGREENA'}, :without_protection => true)
question614.save
...
question615 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion615',:question=>'Routes - the Routes tool with maps was relevant and useful for me',:description=>"",:question_type => 'AGREENA'}, :without_protection => true)
question615.save
...
question616 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion616',:question=>'Action Planning - the Personalized Walking Plan unlocked in Phase 2 was relevant and useful for me',:description=>"",:question_type => 'AGREENA'}, :without_protection => true)
question616.save
...
question617 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion617',:question=>'Action Planning - the Personalized Walking Plan unlocked in Phase 3 that asked me to think about barriers and strategies to overcome them was relevant and useful for me',:description=>"",:question_type => 'AGREENA'}, :without_protection => true)
question617.save
...
question618 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion618',:question=>'Are there any new Support Strategies that you would like to see added to the program?',:description=>"",:question_type => 'SPECIFY'}, :without_protection => true)
question618.save
...
question619 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion619',:question=>'Do you have any final thoughts to share with us about the usability of the website, motivational tools, support strategies, etc.?',:description=>"",:question_type => 'SPECIFY'}, :without_protection => true)
question619.save
...
question620 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion620',:question=>'Overall, I enjoyed using the RISE@Work website:',:description=>"",:question_type => 'AGREE'}, :without_protection => true)
question620.save
...
question621 = SurveyQuestion.find_or_create_by_name({:name => 'FQuestion621',:question=>'Would you be interested in participating in future research with us?',:description=>"",:question_type => 'YESNO'}, :without_protection => true)
question621.save
